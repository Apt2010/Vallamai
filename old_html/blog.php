            ...
            <div class="news-block style-four col-lg-4 col-md-6 col-sm-12 wow fadeInRight">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <figure class="image"><a href="blog_detail.php"><img src="images/news-1.jpg" alt=""></a></figure>
                    </div>
                    <div class="lower-content">
                        
                        <ul class="post-info">
                            <li><span class="far fa-calendar"></span> 31/12/2023</li>
                            <li><span class="far fa-user"></span> Thomas Albart</li>
                        </ul>    
                        <h4><a href="blog_detail.php">Chances are Good That There’s a Cloud Software as </a></h4>
                        <div class="text">Single stroke at the present moment and yet I feel that lorem quis bibendum auctor. <a href="blog_detail.php">[...]</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="news-block style-four col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="400ms">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <figure class="image"><a href="blog_detail.php"><img src="images/news-2.jpg" alt=""></a></figure>
                    </div>
                    <div class="lower-content">
                       
                        <ul class="post-info">
                            <li><span class="far fa-calendar"></span> 31/12/2023</li>
                            <li><span class="far fa-user"></span> Jamika Lora</li>
                        </ul>
                        <h4><a href="blog_detail.php">Chances are Good That There’s a Cloud Software as </a></h4>
                        <div class="text">Single stroke at the present moment and yet I feel that lorem quis bibendum auctor. <a href="blog_detail.php">[...]</a></div>
                    </div>
            ...
            <div class="news-block style-four col-lg-4 col-md-6 col-sm-12 wow fadeInRight" data-wow-delay="800ms">
                <div class="inner-box">
                    <div class="image-box">
                        ...
                        <figure class="image"><a href="blog_detail.php"><img src="images/news-3.jpg" alt=""></a></figure>
                    </div>
                    <div class="lower-content">
                       
                        <ul class="post-info">
                            <li><span class="far fa-calendar"></span> 31/12/2023</li>
                            <li><span class="far fa-user"></span> Nicky Monitor</li>
                        </ul>
                        <h4><a href="blog_detail.php">We Have Top Executive and Start Up Here Event 2023</a></h4>
                        <div class="text">Single stroke at the present moment and yet I feel that lorem quis bibendum auctor. <a href="blog_detail.php">[...]</a></div>
                    </div>
                </div>
            </div>
